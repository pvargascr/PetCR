<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Clientes.aspx.cs" Inherits="PetCRWeb.Clientes" %>
...
<!-- Form Name -->
<legend><center><h2><b>Busqueda y Registro de Clientes</b></h2></center></legend><br>
<!-- Text input-->
...
<div class="form-group">
  <asp:Label ID="lblcorreo" runat="server" text="Correo" CssClass="col-md-4 control-label"></asp:Label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
...
<div class="form-group">
  <asp:Label ID="lbltelefono" runat="server" text="Teléfono" CssClass="col-md-4 control-label"></asp:Label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
 <asp:TextBox ID="txttelefono" runat="server" placeholder="+506" CssClass="form-control"></asp:TextBox>
    </div>
  </div>
</div>
...
<div class="form-group">
  <asp:Label ID="lbldireccion" runat="server" text="Dirección" CssClass="col-md-4 control-label"></asp:Label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
